...
return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>fd", builtin.find_files, { desc = "[F]ind in [D]irectory" })
    ...
    -- -- vim.keymap.set("n", "<leader>sgcf", builtin.git_bcommsts, { desc = "[S]earch [G]it [C]ommits for current [F]ile" })
